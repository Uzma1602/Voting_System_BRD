    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voter_Id', models.PositiveIntegerField(blank=True, null=True, unique=True)),
                ('pic', models.ImageField(upload_to='C:\\Users\\Dell\\Desktop\\Voting\\Vs\\accounts\\userprofile')),
                ('aadhar_no', models.PositiveIntegerField(blank=True, null=True, unique=True)),
                ('state', models.CharField(blank=True, max_length=150, null=True)),
                ('city', models.CharField(blank=True, max_length=150, null=True)),
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female')], max_length=9, null=True)),
